...
public class FrmPedido extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     try {
        ...
        if (cliente.isBlank() || producto.isBlank() || cantidadTexto.isBlank()) {
        ...
        // ejemplo simple de precio fijo (luego lo conectamos a BD Producto)
        double precio = 3.50;

        Pedido pedido = new Pedido(cliente, producto, cantidad, precio);

        double total = pedido.calcularTotal();

        jTextField4.setText(String.valueOf(total));

        JOptionPane.showMessageDialog(this, "Total calculado: " + total);

    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "Cantidad debe ser número");
    }
    ...
    try {
        ...
        String cliente = jTextField1.getText();
        String producto = jTextField2.getText();
        if (cliente.isBlank() || producto.isBlank()
    ...
    return;
        ...
        Pedido pedido = new Pedido(cliente, producto, cantidad, total / cantidad);
        ...
        JOptionPane.showMessageDialog(this, "Revisa los números");
    }
